...
public class PageDTO {
	...
	private int startPage;			// 한 페이지당 페이지목록의 시작번호(pagination 시작번호)
	private int endPage;			// 한 패이지당 페이지목록의 끝번호(pagination 끝번호)
	private int realEndPage;		// 총 레코드 건수에 기반한 총 페이지 수(pagination 마지막번호)
	...
	public PageDTO(Criteria cri, int totalAmount) {
		...
		this.totalAmount = totalAmount;			//현재 시점의 총 레코드 개수
